$( document ).ready(function() {
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown"> \
                          <ul class="navbar-nav"> \
                            ...
                            '<li class="nav-item dropdown"> \
                                ...
                                <a class="dropdown-item" href="admCadastroFuncionario.php">Funcionario</a> \
                                <a class="dropdown-item" href="Cadastro_de_Sedes.php">Sede</a> \
                            ...
                            <li class="nav-item dropdown"> \
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> \
                                <a class="dropdown-item" href="funcionariosDisponiveis.php">Funcionario</a> \
                                <a class="dropdown-item" href="consulta_sede.php">Sede</a> \
                                <a class="dropdown-item" href="IndexDominioSede.php">Encomenda na Sede</a> \
  ...
  $('footer').append('<div style="padding: 10px 0px 10px 0px;" class="container"> \
                        <p>Desenvolvido por Carlos, Nicolas, Yuri, Jaderson, Geyson</a></p> \
                      </div> \
  ') 
